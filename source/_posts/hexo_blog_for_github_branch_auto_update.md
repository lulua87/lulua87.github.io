...
git init
关联本地与远程仓库：
git remote add origin https://github.com/lulua87/lulua87.github.io.git
...
deploy:
  type: git
  repository: git@github.com:lulua87/lulua87.github.io.git 
  branch: master
...
如果安装失败提示如下：
Unexpected end of JSON input while parsing near '...83d8d05128fc9f4d8fbb8

npm cache verify,再npm cache clean --force，最后再npm install


启动部署: index.html等文件部署到master
hexo deploy